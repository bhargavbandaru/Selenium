...
public class TC_CopyCertainText 
...
/*
		...
		String expectedText = driver.findElement(By.xpath("//div[@class='intro-message']//following-sibling::h3[contains(text(),'Copy text')]")).getText();
		String a [] = expectedText.split("and") ;
